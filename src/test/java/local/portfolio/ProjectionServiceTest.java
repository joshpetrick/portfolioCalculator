...
class ProjectionServiceTest {
    ...
    void projectsDividendReinvestmentContributionsAndRsus() {
        ...
        var result = new ProjectionService().project(new PortfolioState(List.of(holding), scenario, List.of(scenario), List.of(new InvestmentAccount("a", "401k", "Retirement", "Investment Account", true, 1000, 1200, 0, 0, 0, List.of()))), 1, "base");
