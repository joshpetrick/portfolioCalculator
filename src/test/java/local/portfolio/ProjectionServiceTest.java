...
class ProjectionServiceTest {
    ...
    void projectsDividendReinvestmentContributionsAndRsus() {
        ...
        var result = new ProjectionService().project(new PortfolioState(List.of(holding), scenario, List.of(scenario), List.of(new InvestmentAccount("a", "401k", "Retirement", 1000, 1200, 0))), 1, "base");
